...
def get_parametric_edge(visible_checking, merged_edge_dict, meta_data_dir=None, detector=None):
    if visible_checking:
        ...
        edge_visibility_threshold = 0.1
        edge_visibility_frames_ratio = 0.05
        num_frames = len(edges)
        edge_visibility_frames = math.\
            ceil(edge_visibility_frames_ratio * num_frames)
